...
exports.Shake256Stream = exports.asyncShake256 = exports.shake256 = void 0;
 ...
 * @return Buffer
 */
function shake256(input, hashLength = 32) {
    let reBuffer = Buffer.alloc(hashLength, 0);
    (0, index_1.syncShake256)(reBuffer, input);
    return reBuffer;
}
...
class Shake256Stream extends stream_1.Transform {
    ...
    _init() {
        ...
        (0, index_1.initState)(this._initState);
    }
    _clearState() {
        (0, index_1.releaseState)(this._initState);
        this._initState = Buffer.alloc(0);
    }
    _destroy() {
    ...
    _final(callback) {
        if (this._initState.length === 8) {
            (0, index_1.finalize)(this._initState);
            let hash = Buffer.alloc(this.hashLength, 0);
            (0, index_1.squeeze)(hash, this._initState);
            this.push(hash);
            this._clearState();
    ...
    _transform(chunk, encoding, callback) {
        if (this._initState.length === 0) {
            ...
            (0, index_1.adsorb)(this._initState, chunk);
            callback();
        }
        else {
